...
//        System.out.println(File.separator);
    ...
    public ResponseEntity<Object> filesearch(@RequestParam("searchValue") String param,@RequestParam("idx") Integer idx,@RequestParam("type") String type,@RequestHeader("Authorization") String token)throws Exception{
        //----------------
        HttpHeaders headers=new HttpHeaders();
        headers.add("Custom-header","foo");
        //----------------
        ...
        if(Objects.equals(type,"public")) {
            jsonObject.put("data",fileTest.filesearch(param,idx1));
    ...
    public ResponseEntity<Object> cxdemo(@RequestParam("idx") Integer idx,@RequestParam("type") String type,@RequestHeader("Authorization") String token){
        HttpHeaders headers=new HttpHeaders();
        headers.add("Custom-Header", "foo");
        ...
        if (Objects.equals(type, "public")) {
            ...
            if(Objects.equals(token,"")){
                jsonObject.put("data",fileTest.cx(idx1));
    ...
    public ResponseEntity<Object> collection(@RequestBody Map<String,String> params,@RequestHeader("Authorization") String token){
        ...
        if(Objects.equals(collect,"false")){
            if(Objects.equals(collectionTest.pdcollect(username,filename),0)){
                ...
                collectionTest.add(filename, username);
                return new ResponseEntity<>(jsonObject, headers, HttpStatus.OK);
            }else {
